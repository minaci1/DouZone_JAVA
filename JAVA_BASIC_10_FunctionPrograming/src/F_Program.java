...
public class F_Program {
	...
	public static void main(String[] args) {
		...
		//선언형  (what)
		//로직 추상화
		//자바...stream API제공 ( 표현 람다식으로)
		int result2 =0;
		result2 =list.stream() //종류 2가지 1. io , 2.데이터를 여가시키는 애들 (통로) -> 우리는 2번 // 스트림은 재사용 x -> 자바도 선언형쓰기 위해 람다식 사용해서 동일한 코드를 통해 논리제공 
						.filter(n -> n %2 ==0) //다시 stream 을 리턴
