...
class CustomerService {
	...
	public List<Customer> searchCustomerByLocation(String location) {
		...
		for (Customer customer : customers) {
			if (customer.getLocation().equals(findCustomers)) {
...
public class F_Program3 {
	...
	public static void initData(CustomerService service) {
		...
		service.addCustomer(new Customer("customer02", "Busan", Gender.Male, 11));
		service.addCustomer(new Customer("customer03", "Gwangju", Gender.Male, 22));
		service.addCustomer(new Customer("customer04", "Gwangju", Gender.Male, 33));
		service.addCustomer(new Customer("customer05", "Sanbon", Gender.FeMale, 44));
		service.addCustomer(new Customer("customer06", "Seoul", Gender.FeMale, 55));
		service.addCustomer(new Customer("customer07", "Seoul", Gender.FeMale, 66));
		service.addCustomer(new Customer("customer08", "Seoul", Gender.FeMale, 77));
		service.addCustomer(new Customer("customer09", "Seoul", Gender.FeMale, 88));
